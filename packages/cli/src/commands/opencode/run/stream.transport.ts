...
import type { Event, GlobalEvent, OpencodeClient } from "@icecode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@icecode/RunStreamTransport") {}
