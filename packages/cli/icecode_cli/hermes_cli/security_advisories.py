"""
Security advisory checker for ICECODE Agent.
...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "Rotate API keys in ~/.icecode/.env (OpenRouter, Anthropic, OpenAI, "
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # ICECODE requires 3.10+ but defensive.
        return None
    try:
...
# ``~/.icecode/cache/advisory_banner_seen`` (a single line per advisory ID:
