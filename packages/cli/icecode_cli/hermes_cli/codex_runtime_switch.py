...
def apply(
    ...
    *,
    ...
    if new_value == "codex_app_server":
        ...
        # ICECODE' MCP servers + Codex's installed curated
        ...
        try:
            from icecode_cli.hermes_cli.codex_runtime_plugin_migration import migrate
            ...
            # ICECODE tool callback are always-on production
            ...
            if "hermes-tools" in mig_report.migrated:
                msg_lines.append(
                    "ICECODE tool callback registered: codex can now use "
                ...
                msg_lines.append(
                    ...
                    "only on the default ICECODE runtime — they need the "
                    "agent loop context.)"
                )
        ...
        msg_lines.append(
            ...
            "ICECODE tools available via MCP callback)."
        )
        msg_lines.append(
        ...
        msg_lines.append("OpenAI/Codex turns will use the default ICECODE runtime.")
