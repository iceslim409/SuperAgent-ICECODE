import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@icecode/sdk/v2/client"
...
import { List, type ListRef } from "@icecode/ui/list"
import { ProviderIcon } from "@icecode/ui/provider-icon"
          ...
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://icecode.ai/zen" tabIndex={-1}>
