...
beforeAll(async () => {
  ...
  mock.module("@icecode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@icecode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@icecode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@icecode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
