...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.icecode/\.env|\~/\.icecode/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references ICECODE secrets file"),
    ...
    (r'\.icecode/config\.yaml|\.icecode/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references ICECODE configuration files directly"),
