...
from icecode_tools.terminal_tool import set_approval_callback as _set_subagent_approval_cb
...
def _dump_subagent_timeout_diagnostic(
    *,
    ...
    writes a dedicated log under ``~/.icecode/logs/subagent-<sid>-<ts>.log``
        ...
        "properties": {
            ...
            "acp_command": {
                ...
                "description": (
                    ...
                    "Leave empty to use the parent's default transport (ICECODE subagents)."
                ),
            },
            "acp_args": {
                "type": "array",
