...
_FORCE_SYNC_ENV = "ICECODE_FORCE_FILE_SYNC"
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``ICECODE_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, hermes_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.icecode/`` directory as a tar archive,
        ...
        # against an uninitialized remote .icecode/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.icecode/skills/a.md`` →
        ``~/.icecode/skills/a.md``, a new remote file at
        ``/root/.icecode/skills/b.md`` maps to ``~/.icecode/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
        for host, remote in mapping:
