"""
Microsoft Teams platform adapter for ICECODE Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "ICECODE"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"ICECODE\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.icecode/.env")
