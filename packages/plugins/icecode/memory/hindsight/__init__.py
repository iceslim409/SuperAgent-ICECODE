...
Or via $ICECODE_HOME/hindsight/config.json (profile-scoped), falling back to
...
def _load_config() -> dict:
    ...
    Resolution order:
      1. $ICECODE_HOME/hindsight/config.json  (profile-scoped)
...
def _embedded_profile_name(config: dict[str, Any]) -> str:
    """Return the Hindsight embedded profile name for this ICECODE config."""
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._retain_context = "conversation between ICECODE Agent and the User"
    ...
    def save_config(self, values, hermes_home):
        """Write config to $ICECODE_HOME/hindsight/config.json."""
        import json
        from pathlib import Path
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from icecode_cli.hermes_cli.memory_setup import _curses_select
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "retain_context", "description": "Context label for retained memories", "default": "conversation between ICECODE Agent and the User"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._retain_context = self._config.get("retain_context", "conversation between ICECODE Agent and the User")
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        document. See icecode-agent#6672.
        ...
        if self._client is not None:
            try:
                if self._mode == "local_embedded":
                    ...
                    # ICECODE created/used that client on the shared async loop,
