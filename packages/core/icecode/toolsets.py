...
_ICECODE_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (ICECODE_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (ICECODE_KANBAN_TASK env "
    ...
    # ==========================================================================
    # ICECODE toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with ICECODE via email (IMAP/SMTP)",
        "tools": _ICECODE_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with ICECODE via SMS (Twilio)",
        "tools": _ICECODE_CORE_TOOLS,
        "includes": []
    },
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        ...
        # Gives them _ICECODE_CORE_TOOLS plus any tools the plugin registered
