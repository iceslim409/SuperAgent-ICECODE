...
Requires: pip install icecode-agent[yc-bench]
"""
...
class YCBenchEvalEnv(HermesAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[YCBenchEvalConfig, List[APIServerConfig]]:
        env_config = YCBenchEvalConfig(
            ...
            steps_per_eval=1,
            total_steps=1,
            tokenizer_name="NousResearch/ICECODE-3-Llama-3.1-8B",
            use_wandb=True,
            wandb_name="yc-bench",
    ...
    async def setup(self):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                '  pip install "icecode-agent[yc-bench]"\n'
    ...
    async def evaluate(self, *args, **kwargs) -> None:
        ...
        try:
            ...
            pbar.close()
            try:
                from icecode_tools.terminal_tool import cleanup_all_environments
