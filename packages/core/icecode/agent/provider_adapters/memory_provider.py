...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hermes_home (str): The active ICECODE_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.icecode``.
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        ``hermes_home`` is the active ICECODE_HOME directory path.
