...
Storage (``~/.icecode/auth/google_oauth.json``, chmod 0o600):
...
#
# Resolution order:
#   1. ICECODE_GEMINI_CLIENT_ID / ICECODE_GEMINI_CLIENT_SECRET env vars (power users)
...
ENV_CLIENT_ID = "ICECODE_GEMINI_CLIENT_ID"
ENV_CLIENT_SECRET = "ICECODE_GEMINI_CLIENT_SECRET"
...
_HEADLESS_ENV_VARS = ("SSH_CONNECTION", "SSH_CLIENT", "SSH_TTY", "ICECODE_HEADLESS")
...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "ICECODE looks for a locally installed gemini-cli to source the OAuth client. "
            "Either:\n"
            "  1. Install it: npm install -g @google/gemini-cli  (or brew install gemini-cli)\n"
            "  2. Set ICECODE_GEMINI_CLIENT_ID and ICECODE_GEMINI_CLIENT_SECRET in ~/.icecode/.env\n"
            "\n"
