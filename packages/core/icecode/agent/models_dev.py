...
Data resolution order (like TypeScript OpenCode):
  ...
  2. Disk cache (~/.icecode/models_dev_cache.json)
...
# ICECODE provider names → models.dev provider IDs
...
def list_provider_models(provider: str) -> List[str]:
    ...
    """
    from icecode_cli.hermes_cli.models import normalize_provider
