"""engine_api_mixin — OpenAI client management, streaming, and API call loop.

Extracted from engine.py: client creation/management, streaming API calls,
fallback handling, vision preprocessing, API kwargs construction, and
context compression.
