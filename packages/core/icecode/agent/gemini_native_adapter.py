...
Why this exists
---------------
Google's OpenAI-compatible endpoint has been brittle for ICECODE's multi-turn
...
_FREE_TIER_GUIDANCE = (
    ...
    "gemini-2.5-flash). ICECODE typically makes 3-10 API calls per user turn, "
...
class GeminiAPIError(Exception):
    """Error shape compatible with ICECODE retry/error classification."""
...
class GeminiNativeClient:
        ...
        **_: Any,
        ...
        if not (api_key or "").strip():
            raise RuntimeError(
                ...
                "Set GOOGLE_API_KEY or GEMINI_API_KEY in your environment / ~/.icecode/.env "
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": "icecode-agent (gemini-native)",
        }
