...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Hermes also honours ICECODE_CA_BUNDLE (its own convention)
    ...
    """
    for env_var in ("ICECODE_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE"):
...
# Minimum context length required to run ICECODE Agent.  Models with fewer
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # ICECODE grow conversations past the runtime limit and Ollama
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot"}:
        try:
            from icecode_cli.hermes_cli.models import get_copilot_model_context
