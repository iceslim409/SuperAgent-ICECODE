#!/usr/bin/env python3
"""Google Workspace API CLI for ICECODE Agent.
...
def _gws_binary() -> str | None:
    override = os.getenv("ICECODE_GWS_BIN")
    if override:
        return override
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for ICECODE Agent")
