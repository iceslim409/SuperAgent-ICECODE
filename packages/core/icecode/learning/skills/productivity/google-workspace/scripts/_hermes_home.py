"""Resolve ICECODE_HOME for standalone skill scripts.
...
instead of duplicating the ``ICECODE_HOME = Path(os.getenv(...))`` pattern.
"""
...
try:
    from icecode.icecode_constants import display_hermes_home as display_hermes_home
    from icecode.icecode_constants import get_hermes_home as get_hermes_home
