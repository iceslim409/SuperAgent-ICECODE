...
Data file: $ICECODE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ICECODE_HOME = Path(os.environ.get("ICECODE_HOME", Path.home() / ".hermes"))
DATA_DIR = _ICECODE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
