 ...
 *   "@icecode/ServerAuthConfig",
 *   {
 *     password: Config.string("ICECODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ICECODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
