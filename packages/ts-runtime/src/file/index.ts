...
import { NonNegativeInt, type DeepMutable, withStatics } from "@icecode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@icecode/File") {}
