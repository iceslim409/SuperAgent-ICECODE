...
import { lazy } from "@icecode/core/util/lazy"
...
import { NonNegativeInt, PositiveInt, withStatics } from "@icecode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@icecode/Pty") {}
