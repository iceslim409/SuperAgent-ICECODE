...
try:
    ...
    _ICECODE_VERSION = "0.0.0"

_APP_VERSION = _ICECODE_VERSION
_BOT_VERSION = _ICECODE_VERSION
_YUANBAO_INSTANCE_ID = str(ICECODE_INSTANCE_ID)  # single source: yuanbao_proto.ICECODE_INSTANCE_ID
