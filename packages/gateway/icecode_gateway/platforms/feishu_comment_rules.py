...
Config: ~/.icecode/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.icecode/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (ICECODE_HOME-aware and
